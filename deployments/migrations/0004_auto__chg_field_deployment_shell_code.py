...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Deployment.shell_code'
        db.alter_column(u'deployments_deployment', 'shell_code', self.gf('django.db.models.fields.TextField')(max_length=500))

    def backwards(self, orm):

        # Changing field 'Deployment.shell_code'
        db.alter_column(u'deployments_deployment', 'shell_code', self.gf('django.db.models.fields.CharField')(max_length=500))
