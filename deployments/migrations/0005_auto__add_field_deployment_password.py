...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Deployment.password'
        db.add_column(u'deployments_deployment', 'password',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=748),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Deployment.password'
        db.delete_column(u'deployments_deployment', 'password')
