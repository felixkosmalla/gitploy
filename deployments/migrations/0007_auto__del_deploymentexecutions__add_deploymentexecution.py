...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'DeploymentExecution'
        db.create_table(u'deployments_deploymentexecution', (
        ...
        db.send_create_signal(u'deployments', ['DeploymentExecution'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'DeploymentExecution'
        db.delete_table(u'deployments_deploymentexecution')
    ...
    models = {
        ...
        u'deployments.deploymentexecution': {
            'Meta': {'object_name': 'DeploymentExecution'},
