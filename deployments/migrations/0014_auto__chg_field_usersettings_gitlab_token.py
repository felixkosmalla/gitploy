...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserSettings.gitlab_token'
        db.alter_column(u'deployments_usersettings', 'gitlab_token', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'UserSettings.gitlab_token'
        db.alter_column(u'deployments_usersettings', 'gitlab_token', self.gf('django.db.models.fields.CharField')(default='', max_length=200))
