...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Hook.creator'
        db.add_column(u'deployments_hook', 'creator',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True),
                      keep_default=False)

        # Adding field 'Hook.created_at'
        db.add_column(u'deployments_hook', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Hook.creator'
        db.delete_column(u'deployments_hook', 'creator_id')

        # Deleting field 'Hook.created_at'
        db.delete_column(u'deployments_hook', 'created_at')
