...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DeploymentExecution.invoked_by'
        db.add_column(u'deployments_deploymentexecution', 'invoked_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DeploymentExecution.invoked_by'
        db.delete_column(u'deployments_deploymentexecution', 'invoked_by_id')
