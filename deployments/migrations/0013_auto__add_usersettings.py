...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'deployments_usersettings', (
            ...
            ('gitlab_token', self.gf('django.db.models.fields.CharField')(default=None, max_length=200, blank=True)),
        ))
        db.send_create_signal(u'deployments', ['UserSettings'])


    def backwards(self, orm):
        # Deleting model 'UserSettings'
        db.delete_table(u'deployments_usersettings')
    ...
    models = {
        ...
        u'deployments.usersettings': {
            ...
            'gitlab_token': ('django.db.models.fields.CharField', [], {'default': 'None', 'max_length': '200', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
