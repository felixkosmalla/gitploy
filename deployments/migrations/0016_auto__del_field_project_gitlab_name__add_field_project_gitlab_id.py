...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Project.gitlab_name'
        db.delete_column(u'deployments_project', 'gitlab_name')

        # Adding field 'Project.gitlab_id'
        db.add_column(u'deployments_project', 'gitlab_id',
                      self.gf('django.db.models.fields.IntegerField')(default=-1, max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Project.gitlab_name'
        db.add_column(u'deployments_project', 'gitlab_name',
                      self.gf('django.db.models.fields.CharField')(default=-1, max_length=250),
                      keep_default=False)

        # Deleting field 'Project.gitlab_id'
        db.delete_column(u'deployments_project', 'gitlab_id')
